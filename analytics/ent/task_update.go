...
func (tu *TaskUpdate) SetTimestamp(i int64) *TaskUpdate {
	tu.mutation.ResetTimestamp()
	tu.mutation.SetTimestamp(i)
	return tu
}

// SetNillableTimestamp sets the "timestamp" field if the given value is not nil.
func (tu *TaskUpdate) SetNillableTimestamp(i *int64) *TaskUpdate {
	if i != nil {
		tu.SetTimestamp(*i)
	}
	return tu
...
func (tu *TaskUpdate) AddTimestamp(i int64) *TaskUpdate {
	tu.mutation.AddTimestamp(i)
	return tu
}
...
func (tu *TaskUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.Timestamp(); ok {
		_spec.SetField(task.FieldTimestamp, field.TypeInt64, value)
	}
	if value, ok := tu.mutation.AddedTimestamp(); ok {
		_spec.AddField(task.FieldTimestamp, field.TypeInt64, value)
	}
...
// SetTimestamp sets the "timestamp" field.
func (tuo *TaskUpdateOne) SetTimestamp(i int64) *TaskUpdateOne {
	tuo.mutation.ResetTimestamp()
	tuo.mutation.SetTimestamp(i)
	return tuo
}

// SetNillableTimestamp sets the "timestamp" field if the given value is not nil.
func (tuo *TaskUpdateOne) SetNillableTimestamp(i *int64) *TaskUpdateOne {
	if i != nil {
		tuo.SetTimestamp(*i)
	}
	return tuo
...
// AddTimestamp adds i to the "timestamp" field.
func (tuo *TaskUpdateOne) AddTimestamp(i int64) *TaskUpdateOne {
	tuo.mutation.AddTimestamp(i)
	return tuo
}
