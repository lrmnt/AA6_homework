...
import (
	...
	"github.com/lrmnt/AA6_homework/analytics/ent/migrate"
...
type Client struct {
	...
	// BillingOperations is the client for interacting with the BillingOperations builders.
	BillingOperations *BillingOperationsClient
...
func (c *Client) init() {
	...
	c.BillingOperations = NewBillingOperationsClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		ctx:               ctx,
		config:            cfg,
		BillingOperations: NewBillingOperationsClient(cfg),
...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.BillingOperations.Intercept(interceptors...)
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	switch m := m.(type) {
	case *BillingOperationsMutation:
		return c.BillingOperations.mutate(ctx, m)
	case *TaskMutation:
...
// BillingOperationsClient is a client for the BillingOperations schema.
type BillingOperationsClient struct {
	config
}

// NewBillingOperationsClient returns a client for the BillingOperations from the given config.
func NewBillingOperationsClient(c config) *BillingOperationsClient {
	return &BillingOperationsClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `billingoperations.Hooks(f(g(h())))`.
func (c *BillingOperationsClient) Use(hooks ...Hook) {
	c.hooks.BillingOperations = append(c.hooks.BillingOperations, hooks...)
}

// Intercept adds a list of query interceptors to the interceptors stack.
// A call to `Intercept(f, g, h)` equals to `billingoperations.Intercept(f(g(h())))`.
func (c *BillingOperationsClient) Intercept(interceptors ...Interceptor) {
	c.inters.BillingOperations = append(c.inters.BillingOperations, interceptors...)
}

// Create returns a builder for creating a BillingOperations entity.
func (c *BillingOperationsClient) Create() *BillingOperationsCreate {
	mutation := newBillingOperationsMutation(c.config, OpCreate)
	return &BillingOperationsCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of BillingOperations entities.
func (c *BillingOperationsClient) CreateBulk(builders ...*BillingOperationsCreate) *BillingOperationsCreateBulk {
	return &BillingOperationsCreateBulk{config: c.config, builders: builders}
}

// MapCreateBulk creates a bulk creation builder from the given slice. For each item in the slice, the function creates
// a builder and applies setFunc on it.
func (c *BillingOperationsClient) MapCreateBulk(slice any, setFunc func(*BillingOperationsCreate, int)) *BillingOperationsCreateBulk {
	rv := reflect.ValueOf(slice)
	if rv.Kind() != reflect.Slice {
		return &BillingOperationsCreateBulk{err: fmt.Errorf("calling to BillingOperationsClient.MapCreateBulk with wrong type %T, need slice", slice)}
	}
	builders := make([]*BillingOperationsCreate, rv.Len())
	for i := 0; i < rv.Len(); i++ {
		builders[i] = c.Create()
...
// Update returns an update builder for BillingOperations.
func (c *BillingOperationsClient) Update() *BillingOperationsUpdate {
	mutation := newBillingOperationsMutation(c.config, OpUpdate)
	return &BillingOperationsUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *BillingOperationsClient) UpdateOne(bo *BillingOperations) *BillingOperationsUpdateOne {
	mutation := newBillingOperationsMutation(c.config, OpUpdateOne, withBillingOperations(bo))
	return &BillingOperationsUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *BillingOperationsClient) UpdateOneID(id int) *BillingOperationsUpdateOne {
	mutation := newBillingOperationsMutation(c.config, OpUpdateOne, withBillingOperationsID(id))
	return &BillingOperationsUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for BillingOperations.
func (c *BillingOperationsClient) Delete() *BillingOperationsDelete {
	mutation := newBillingOperationsMutation(c.config, OpDelete)
	return &BillingOperationsDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a builder for deleting the given entity.
func (c *BillingOperationsClient) DeleteOne(bo *BillingOperations) *BillingOperationsDeleteOne {
	return c.DeleteOneID(bo.ID)
}

// DeleteOneID returns a builder for deleting the given entity by its id.
func (c *BillingOperationsClient) DeleteOneID(id int) *BillingOperationsDeleteOne {
	builder := c.Delete().Where(billingoperations.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &BillingOperationsDeleteOne{builder}
}

// Query returns a query builder for BillingOperations.
func (c *BillingOperationsClient) Query() *BillingOperationsQuery {
	return &BillingOperationsQuery{
		config: c.config,
		ctx:    &QueryContext{Type: TypeBillingOperations},
		inters: c.Interceptors(),
	}
}

// Get returns a BillingOperations entity by its id.
func (c *BillingOperationsClient) Get(ctx context.Context, id int) (*BillingOperations, error) {
	return c.Query().Where(billingoperations.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *BillingOperationsClient) GetX(ctx context.Context, id int) *BillingOperations {
...
// QueryUser queries the user edge of a BillingOperations.
func (c *BillingOperationsClient) QueryUser(bo *BillingOperations) *UserQuery {
	query := (&UserClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := bo.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(billingoperations.Table, billingoperations.FieldID, id),
...
func (c *BillingOperationsClient) Hooks() []Hook {
	return c.hooks.BillingOperations
}

// Interceptors returns the client interceptors.
func (c *BillingOperationsClient) Interceptors() []Interceptor {
	return c.inters.BillingOperations
}

func (c *BillingOperationsClient) mutate(ctx context.Context, m *BillingOperationsMutation) (Value, error) {
	switch m.Op() {
	case OpCreate:
		return (&BillingOperationsCreate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdate:
		return (&BillingOperationsUpdate{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpUpdateOne:
		return (&BillingOperationsUpdateOne{config: c.config, hooks: c.Hooks(), mutation: m}).Save(ctx)
	case OpDelete, OpDeleteOne:
		return (&BillingOperationsDelete{config: c.config, hooks: c.Hooks(), mutation: m}).Exec(ctx)
	default:
		return nil, fmt.Errorf("ent: unknown BillingOperations mutation op: %q", m.Op())
	}
}
...
type (
	hooks struct {
		BillingOperations, Task, TaskLog, User, UserLog []ent.Hook
	}
	inters struct {
		BillingOperations, Task, TaskLog, User, UserLog []ent.Interceptor
	}
)
